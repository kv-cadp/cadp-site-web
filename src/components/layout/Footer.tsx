    ...
    <footer className="bg-navy-deep text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          {/* Formations */}
          <div>
            <h3 className="font-serif text-lg text-gold mb-4">Formations</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-cream/70">
              <li className="flex gap-2">
                <svg className="size-5 shrink-0 text-gold/60 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                <a href={SITE.phoneHref} className="flex gap-2 hover:text-gold transition-colors">
                  <svg className="size-5 shrink-0 text-gold/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                <a href={`mailto:${SITE.email}`} className="flex gap-2 hover:text-gold transition-colors">
                  <svg className="size-5 shrink-0 text-gold/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
